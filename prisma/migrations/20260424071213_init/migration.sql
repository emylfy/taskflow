...
-- CreateIndex
CREATE INDEX "Task_projectId_status_orderIndex_idx" ON "Task"("projectId", "status", "orderIndex");
...
-- CreateIndex
CREATE INDEX "YjsSnapshot_taskId_idx" ON "YjsSnapshot"("taskId");
...
-- AddForeignKey
ALTER TABLE "YjsSnapshot" ADD CONSTRAINT "YjsSnapshot_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;
